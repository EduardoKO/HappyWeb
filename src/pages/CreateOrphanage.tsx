        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input value={opening_hours} onChange={event => setOpeningHours(event.target.value)} id="opening_hours" />           </div>
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                ...
                <button onClick={() => setOpenOnWeekends(false)} className={!open_on_weekends ? 'active' : ''} type="button">Não</button>
              </div>
            </div>
          </fieldset>
